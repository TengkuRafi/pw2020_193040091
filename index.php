...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="indexluar.css">
  </head>
  <body>
      <div class="card">
  <div class="card text-center">
  <div class="card-header text-white" style="c">
    Featured
  </div>
  <div class="card text-white bg-dark card border-warning">
  <div class="card-body ">
    <h5 class="card-title text-white">Tugas Besar</h5>
    <p class="card-text text-white">Menuju Tugas besar Silahkan klik dibawah ini!</p>
    <a href="tubes/index.php" class="btn btn-primary">Tugas Besar</a>
  </div>
</div>
</div>
